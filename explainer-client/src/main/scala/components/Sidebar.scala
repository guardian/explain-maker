...
object Sidebar {
  ...
  def sidebar(explainer: CsAtom, status: PublicationStatus, workflowStatus: WorkflowStatus) = {
    ...
    form()(
      span(cls:="text-atom-guide-link")(a(href:="https://docs.google.com/document/d/1-o4kOXINgsxxotUYlkEoyqcwnJLrtc54Nv7m2S3l_7c/edit?ts=57e13f8a", target:="_blank")("How-to Guide")),
      div(cls:="form-row")(
